...
LED_DIFFER		= 48			# Numéro de la LED où porte de Gouesnou et porte de Guipavas se séparent
...
DELAY_NR 		= 2.0			# Délai d'attente quand une requête échoue (en secondes)
...
###### ====================== ETAPE 1 ====================== ######
    ...
    # On fait la requête sur l'API avec en paramètre: le format (json), le numéro de ligne (A pour le tram), la direction vers la Porte de ...
    ...
    # Si la requête n'est pas du JSON on affiche un message d'erreur et on sort de la boucle
        ...
        print("\"reponse\" n'est pas du json")
